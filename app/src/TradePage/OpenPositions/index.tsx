...
import { calcTotalPrice, getPutOrCallFullText, getOpenPositionTotalPrice } from '../common/utils';
      ...
      <tbody>
        {openPositions.map((openPosition) => (
          <tr key={openPosition.symbol}>
            ...
            <td>
              {(
                ((openPosition.position * openPosition.markPrice) / getOpenPositionTotalPrice({ openPositions })) *
                100
              ).toFixed(2)}
              %
            </td>
